...
//    2) This file defines channels for both the C++ code and the MXRP
...
#define CTL_ENABLE_SW      34  /* Enables the use of the reset, freeze and reload switches (PINKY switch) */
